...
@Component
public class ExceptionHander500 implements HandlerExceptionResolver {
	private final Logger logger = LoggerFactory.getLogger(ExceptionHander500.class);
...
//						e.getMessage());
		...
		responseResult(response, result,httpStatus);
		return new ModelAndView();
	}

	private void responseResult (HttpServletResponse response, Result result,int httpStatus) {

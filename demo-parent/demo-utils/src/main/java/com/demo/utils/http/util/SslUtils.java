...
public class SslUtils {
     ...
     * @throws Exception
     */
    public static HashMap<String, String> post(String url, Map<String, String> header, Map<String, String> param, StringEntity entity) throws Exception {
        String result = "";
     ...
     * @throws Exception
     */
    public static HashMap<String, String> postSign(String url, Map<String, String> header, Map<String, String> param, StringEntity entity) throws Exception {
        HashMap<String, String> responseMap = new HashMap<String, String>();
        ;
        String result = "";
        CloseableHttpClient httpClient = null;
